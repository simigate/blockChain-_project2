...
contract StarNotary is ERC721 {
    ...
    function createStar(string memory _name, uint256 _tokenId) public {
        ...
        require(bytes(_name).length > 0, "Star name is empty");
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(
            ...
            "The exchange request should be from one of star owners"
        );
        //2. You don't have to check for the price of the token (star)
        /*uint256 star1Price = starsForSale[_tokenId1];
        uint256 star2Price = starsForSale[_tokenId2];
        require(
            star1Price[_tokenId] > 0 && star2Price > 0,
            "The Stars should be up for sale"
        );*/
        ...
        /* delete starsForSale[_tokenId1];
        delete starsForSale[_tokenId2];*/
    }
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(
            owner == msg.sender,
            "Transfer can be performed only by the owner of the Star."
        );
